...
const stage3 = {
  ...
  lessons: [
    ...
    // ── Lesson 3-3: Inserting Corners ─────────────────────────────
    {
      ...
      steps: [
        {
          text: "**Setup:** Flip your cube so [White] is on the **bottom** and [Yellow] is on top.\n\nFind a white corner in the **top layer**. Turn the top ({U}) to position that corner so it's at the **front-right** — directly above the spot where it belongs. Its non-white colors should match the front and right centers.",
        },
        {
